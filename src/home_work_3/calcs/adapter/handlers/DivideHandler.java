...
public class DivideHandler extends PatternHandler implements IHandler, Comparable<IHandler> {
    ...
    protected double calculate(Matcher matcher) {
        ...
        return this.calculator.divide(Double.parseDouble(operand1), Double.parseDouble(operand2));
    }
